...
const PreviewOperation = document.querySelector('[data-previous-operand]')
const CurrentOperation = document.querySelector('[data-current-operand]')


class Calculator {
    constructor(PreviewOperation, CurrentOperation) {
    ...
    updateDisplay() {
        ...
        if (this.operation != null) {
            this.PreviewOperation.innerText =
...
const calculator = new Calculator(PreviewOperation, CurrentOperation)
